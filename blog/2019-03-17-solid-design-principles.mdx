...
<button onClick={() => window.open('https://gkovan.medium.com/solid-design-principles-makes-test-driven-development-faster-and-easier-35c9eec22ff1', '_blank')}>Click to view full blog on the medium site!</button>
