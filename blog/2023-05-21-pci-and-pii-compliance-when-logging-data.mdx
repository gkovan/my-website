...
<button onClick={() => window.open('https://gkovan.medium.com/pci-and-pii-compliance-when-logging-data-in-digital-transformation-projects-7739bab159a6', '_blank')}>Click me to open the blog!</button>
